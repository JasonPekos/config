...
-- Ctrl-a to jump to the start of the line in insert mode
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'julia', 'R' },
      ...
      textobjects = {
        select = {
          ...
          lookahead = true,
          keymaps = {
            ['am'] = '@function.outer', -- Select around the function
            ['im'] = '@function.inner', -- Select inside the function
          },
        },
      },
